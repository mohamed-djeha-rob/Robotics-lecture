...
%\newfontfamily\arabicfont[Script=Arabic]{Amiri}  % Choose an Arabic font
...
\def\matriceJdot{\mathbf{\dot{J}}}
\def\matriceT{\mathbf{T}}
\def\matriceI{\mathbf{I}}
\def\matriceP{\mathbf{P}}
\def\vectorB{\bm{b}}
\def\vectorD{\bm{d}}
\def\vectorH{\bm{h}}
\def\vectorX{\bm{x}}
...
\input{Modélisation_géométrique.tex}	
%\section{Modélisation Cinématique}
\input{Modélisation_cinématique.tex}
\section{Dynamics Modeling}%QP control strategies %New possibilities wit QP
\input{Modélisation_dynamique.tex}
%\input{New Control Strategies.tex}
%\input{Multi-robot Control.tex}
\section{Industrial Robots Control}
%\input{Industrial_robot_control.tex}
